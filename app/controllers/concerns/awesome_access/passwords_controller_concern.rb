module AwesomeAccess::PasswordsControllerConcern
  ...
  def new
    @person = AwesomeAccess.configuration.user_model.constantize.new
    render AwesomeAccess.configuration.new_passwords_view_path
  end
  def create
    @person = AwesomeAccess.configuration.user_model.constantize.where(email: params[:email]).first_or_initialize
  ...
  def edit
    @person = AwesomeAccess.configuration.user_model.constantize.where(email: params[:email]).first
